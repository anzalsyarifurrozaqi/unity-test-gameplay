...
public class CheckRightBlocking : PlayerFunction {
    public override void RunFunction(float rayDistance) {
        foreach (GameObject obj in PlayerControl.DATASET.COLLISION_SPHERES_DATA.RightSpheres) {
            RaycastHit[] hits;
            ...
            foreach (RaycastHit hit in hits) {
                AddObjectToDictionary.Add(
                    PlayerControl.DATASET.BLOCKING_DATA.RightBlockingObjects,
                    obj,
