...
namespace WaterSystem.Data {
    ...
    public class WaterSurfaceDataEditor : Editor {
        ...
        private void OnValidate() {
            ...
            // Check can remove to make sure ata least one wave remains
        ...
        public override void OnInspectorGUI() {
            ...
            switch (foamType.intValue) {
                ...
                case 2: {//// Density ////
                    ...
                    denseFoam.animationCurveValue = EditorGUILayout.CurveField(denseFoam.animationCurveValue, new Color(0.5f, 0.75f, 1f, 1f), new Rect(Vector2.zero, Vector2.one));
                    EditorGUILayout.EndHorizontal();
                    break;
                }
            }
            ...
            switch(customWaves.boolValue ? 1 : 0) {
                case 0: { //// Automatic ////
                    ...
                    EditorGUILayout.Slider(avgHeight, 0.1f, 30.0f, new GUIContent("Avg Wavelength", avgWavelengthTT), null);
                    // Wind direction - slider -180 - 180
                    EditorGUILayout.BeginHorizontal();
                    var winDir = basicSettings.FindPropertyRelative("direction");
                    EditorGUILayout.Slider(winDir, -180f, 180f, new GUIContent("Wind Direction"), null);
                    if (GUILayout.Button(new GUIContent("Align to scene camera", alignButtonTT))) {
                        winDir.floatValue = CameraRelativeDirection();
                    }
                    EditorGUILayout.EndHorizontal();
        ...
        private Vector2 CameraRelativeOrigin(Vector2 original) {
        ...
        private Gradient DefaultScatterGrad() {
        ...
        private Gradient DefaultAbsorptionGrad() {
            Gradient g = new Gradient();
        ...
        static string[] wavesTypeOptions = new string[2] { "Automatic", "Customized" };
...
// TODO 
// Bug on OnValidate make waveList are null